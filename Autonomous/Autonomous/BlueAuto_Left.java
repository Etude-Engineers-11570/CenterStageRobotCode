...
public class BlueAuto_Left extends LinearOpMode {
    ...
    OpenCvWebcam webcam;
    CenterStageDetectionPipeline pipeline;
    CenterStageDetectionPipeline.PropPosition snapshotAnalysis = CenterStageDetectionPipeline.PropPosition.LEFT; // default
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (TuningOpModes.DRIVE_CLASS.equals(MecanumDrive.class)) {
            ...
            pipeline = new CenterStageDetectionPipeline();
