...
public class RedAuto_Left_Detect extends LinearOpMode {
    ...
    OpenCvWebcam webcam;
    SkystoneDetermination_RedLeft pipeline;
    SkystoneDetermination_RedLeft.SkystonePosition snapshotAnalysis = SkystoneDetermination_RedLeft.SkystonePosition.RIGHT; // default
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (TuningOpModes.DRIVE_CLASS.equals(MecanumDrive.class)) {
            ...
            pipeline = new SkystoneDetermination_RedLeft();
                ...
                case CENTER: {
                    ...
                    Actions.runBlocking(
                            drive.actionBuilder(new Pose2d(-36, -60, -1.57))
                                    ...
                                    .strafeToConstantHeading(new Vector2d(-34, -36))
                                    .build());
                    robot.Claw.setPosition(robot.ClawTurnStart);
                    break;
                ...
                case RIGHT: {
                    ...
                    Actions.runBlocking(
                            drive.actionBuilder(new Pose2d(-36, -60, -1.57))
                                    ...
                                    .turn(-1.70)
                                    .strafeToConstantHeading(new Vector2d(-32.25,-32))
                                    .build());
                    robot.Claw.setPosition(robot.ClawTurnStart);
                    break;
