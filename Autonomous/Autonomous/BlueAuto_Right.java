...
public class BlueAuto_Right extends LinearOpMode {
            ...
            switch (snapshotAnalysis) {
                ...
                case CENTER: {
                    Actions.runBlocking(
                            drive.actionBuilder(new Pose2d(12.5, -60, 1.57))
                                    .setTangent(0)
                                    .strafeToConstantHeading(new Vector2d(12.5, -32)) //Go to Place on Center Spike Mark
                                    .waitSeconds(1)
                                    .build());
                    Actions.runBlocking(
                            drive.actionBuilder(new Pose2d(12.5, -32, 1.57))
                                    .strafeToConstantHeading(new Vector2d(12.5, -50)) //Go back to starting position
                                    .waitSeconds(1)
                                    .strafeToConstantHeading(new Vector2d(38, -50)) // Move to backstage
                                    .waitSeconds(1)
